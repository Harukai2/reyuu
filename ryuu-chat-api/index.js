...
function buildAPI(globalOptions, html, jar) {
	...
	const userID = objCookie.i_user || objCookie.c_user;  // Use i_user if available, otherwise fallback to c_user
	...
	const ctx = {
			userID: objCookie.i_user || objCookie.c_user,  // Prioritize i_user (secondary profile)
    i_userID: objCookie.i_user || null,
			jar: jar,
			clientID: clientID,
